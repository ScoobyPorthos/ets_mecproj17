function [ Wto, Wfuel, Wempty ] = itertow( Type, M_cruise, H_cruise, ...
    A, TSFC, T_loiter, Fuel_res, Fuel_trap, Wpayload,CD0, Range );
...
% ---------------------------------------------------------------------
options=optimset();
Wto=fzero(@(Wto)fpoids(Wto,Range,CD0),[Wpayload 1e4*Wpayload],options);
...
% ---------------------------------------------------------------------
    ...
    function resw = fpoids(Wto,Range,CD0)
% ---------------------------------------------------------------------
